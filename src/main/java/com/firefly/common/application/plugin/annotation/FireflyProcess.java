...
package com.firefly.common.application.plugin.annotation;
 ...
 * @since 1.0.0
 * @see com.firefly.common.application.plugin.ProcessPlugin
 * @see com.firefly.common.application.plugin.ProcessMetadata
 * @see com.firefly.common.application.plugin.ProcessPluginRegistry
 */
